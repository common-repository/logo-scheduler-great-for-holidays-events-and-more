...
/**
 * Public shortcodes for the plugin
 *
...
class Shortcodes {
	...
	public function enqueue_scripts() {
		...
		//wp_enqueue_script( $this->plugin_name . '-frontend', plugin_dir_url( __FILE__ ) . 'js/amwnlogos-frontend.js', array( 'jquery' ), $this->version, false );
